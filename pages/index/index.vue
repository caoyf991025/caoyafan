<template>
	<view class="home">
		...
		<view class="map-view">
			<view class="location">
				...
				<view class="map" @tap="getRegeo">
					<image src="../../static/指南页面/位置.png" mode="" class="search-img"></image>
				</view>
				<!-- 城市 -->
				<view   class="city">
					 {{addressName}}
			...
			<view class="search">
				...
				<view class="font-search" @tap="searchKeyWords">
					<image  src="../../static/指南页面/搜索.png" mode="" class="search-img"></image>
				</view>
			</view>
		</view>
			...
			<view class="distinguish">
				...
				<view class="">
					<view class="voice" @touchstart="startRecord" @touchend="endRecord">
						<image src="../../static/指南页面/语音识别.png" mode="" class="img-size1"></image>
					</view>
				</view>
				...
				<view class="">
					<view class="scan">
						<image src="../../static/指南页面/扫描识别.png" mode="" class="img-size"></image>
					</view>
				</view>
				...
				<view class="">
					<view class="photo">
						<image src="../../static/指南页面/图片识别.png" mode="" class="img-size" @click="imgShiBie"></image>
					</view>
				</view>
			</view>
			<!-- 文字描述 -->
		...
		<view class="general_knowledge">
			...
			<view >
				<image src="../../static/指南页面/轮播图.png" mode="" class="knowledge_img"></image>
			</view>
		</view>
				...
				<view >
					<view class="main-classify">
						<view class="classifys" @click="shi">
							<image src="../../static/指南页面/湿垃圾.png" class="classify-img" mode=""></image>
								<view class="classify-size">
									<text class="text1">湿垃圾</text>
								</view>
						</view>
						<view class="classifys" @click="gan">
						  <image src="../../static/指南页面/干垃圾.png" class="classify-img" mode=""></image>
								<view class="classify-size">
					...
					<view class="main-classify">
						<view class="classifys" @click="kehuishou">
							<image src="../../static/指南页面/可回收物.png" class="classify-img" mode=""></image>
								<view class="classify-size">
						...
						<view class="main-classify">
							<view class="classifys" @click="youhai">
								<image src="../../static/指南页面/有害垃圾.png" class="classify-img" mode=""></image>
								<view class="classify-size">
